...
df = pd.read_csv("lab7/data/my_dataset_3classes.csv", delimiter=',', header=0, names=['sentence', 'label'])
...
from transformers import BertForSequenceClassification, PretrainedConfig

# Загрузка теперь делается через конфигурационный файл, в котором изменен размер словаря
configuration = PretrainedConfig.from_pretrained('lab7/data/config_rutoxic.json')
...
model_dir = 'lab7/model_save_toxic/'
